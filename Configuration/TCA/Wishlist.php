...
$TCA['tx_cbwishlist_domain_model_wishlist'] = array(
	'ctrl' => $TCA['tx_cbwishlist_domain_model_wishlist']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_cbwishlist_domain_model_wishlist.pid=###CURRENT_PID### AND tx_cbwishlist_domain_model_wishlist.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:cb_wishlist/Resources/Private/Language/locallang_db.xlf:tx_cbwishlist_domain_model_wishlist.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
